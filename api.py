...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str,
        ...
        """Метод отправляет и размещает на сервере данные о добавляемом питомце, включая фото, и возвращает статус
    ...
    def create_pet_simple(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
        """Метод отправляет и размещает на сервере данные о добавляемом питомце, без фото, и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленного питомца"""
    ...
    def add_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет и размещает на сервере фото питомца по указанному ID, и возвращает статус
        запроса на сервер и результат в формате JSON с данными добавленного питомца"""
